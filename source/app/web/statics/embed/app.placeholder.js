;(function({axios, faker, ejs} = {axios: globalThis.axios, faker: globalThis.faker, ejs: globalThis.ejs}) {
  ...
  globalThis.placeholder = async function(set) {
    ...
    const data = {
      ...
      //Meta-data
      meta: {version: set.version, author: "siosios", generated: new Date().toGMTString().replace(/GMT$/g, "").trim()},
      //Animated
      animated: false,
      //Display size
              ...
              list: [
                {
                  ...
                  entities: {
                    mentions: [{start: 22, end: 33, username: "siosios"}],
                  },
                  text: 'Checkout metrics from  <span class="mention">@siosios</span>  !  <span class="hashtag">#GitHub</span> ',
                  mentions: ["siosios"],
                },
            ...
            starlists: {
              lists: new Array(Number(options["starlists.limit"])).fill(null).map(_ => ({
                ...
                repositories: new Array(Number(options["starlists.limit.repositories"])).fill(null).map((_, i) => ({
                  ...
                  name: !i ? "siosios/metrics" : `${faker.lorem.word()}/${faker.lorem.word()}`,
                })),
              })),
            },
          })
