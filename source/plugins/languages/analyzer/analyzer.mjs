...
export class Analyzer {
  /**Constructor */
  constructor(login, {account = "bypass", authoring = [], uid = crypto.randomBytes(16).toString("hex"), shell, rest = null, context = {mode: "user"}, skipped = [], categories = ["programming", "markup"], timeout = {global: NaN, repositories: NaN}}) {
    //User informations
    this.login = login
