...
RUN chmod +x /metrics/source/app/action/index.mjs \
  ...
  && apt-get update \
  && apt-get install -y libxml2-dev libxslt1-dev zlib1g-dev wget gnupg ca-certificates libgconf-2-4 libterm-readline-gnu-perl \
  && apt-get install libgconf-2-4 libatk1.0-0 libatk-bridge2.0-0 libgdk-pixbuf2.0-0 libgtk-3-0 libgbm-dev libnss3-dev libxss-dev \
